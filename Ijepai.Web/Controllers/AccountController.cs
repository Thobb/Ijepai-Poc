        ...
        public async Task<JsonResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    var viewResult = ViewEngines.Engines.FindPartialView(ControllerContext, "_LogoutPartial");
                ...
                {
                    result = Json(new { Status = 1, MessageTitle = "Log in Unsuccessful.", MessageBody = "Either password or Username is incorrect." });
                }
            }
